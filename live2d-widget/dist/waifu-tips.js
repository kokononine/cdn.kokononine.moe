    ...
    constructor(e, t, s) {
        this.config = t, this.tools = {
            ...
            asteroids: {
                ...
                callback: () => {
                    if (window.Asteroids) window.ASTEROIDSPLAYERS || (window.ASTEROIDSPLAYERS = []), window.ASTEROIDSPLAYERS.push(new window.Asteroids);
                        ...
                        e.src = "https://cdn.kokononine.moe/live2d-widget/dist/asteroids.js", document.head.appendChild(e)
                    }
                }
            },
            "switch-model": {
            ...
            info: {
                ...
                callback: () => {
                    open("https://blog.kokononine.moe/2025/12/17/add-live2d-widget-with-argon-theme/")
                }
            },
            quit: {
